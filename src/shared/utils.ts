 ...
 *
 * The optional chain is what lets a plain Node/test runner import this file: `import.meta.env`
 * is Vite's, so it is undefined outside a Vite build, and because most of `src/` reaches this
 * module a bare property access here made the whole store and hook layer untestable.
 */
export const IS_PLATFORM = import.meta.env?.VITE_IS_PLATFORM === 'true';

/**
 * Indicates whether the compact mobile sidebar is enabled: it hides the mobile Report
 * Issue/Discord links and moves the Settings entry point to the mobile header (tap the title)
 * instead of the sidebar footer, to maximize vertical space for the project list.
 */
...
const DEFAULT_PAGE_TITLE = 'CloudCLI';
